    ...
    public class AccountController : Controller
    {
        ...
        public IHttpResponse Register(IHttpRequest req, RegisterViewModel model)
        {
            ...
            if (string.IsNullOrWhiteSpace(model.Name) ||
                ...
                model.Password.Length > 80 ||
                model.ConfirmPassword.Length < 3 ||
                model.ConfirmPassword.Length > 80 ||
            ...
            var success = this.userService.Create(model.Name, model.Username, model.Password);
        ...
        public IHttpResponse Profile(IHttpRequest req)
        {
            ...
            // Return Profle View
            this.ViewData["name"] = profile.Name;
